      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="backdrop-blur-xl bg-white/[0.03] border border-white/10 rounded-[28px] p-8 md:p-10 max-w-2xl"
          >

            {/* Top Label */}
            <p className="text-sm uppercase tracking-[5px] text-cyan-400 mb-6">
              About Me
            </p>

            {/* Main Text */}
            <p className="text-xl md:text-2xl text-gray-200 leading-[1.7] font-light">
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              ...
              {[
                ...
                <span
                  key={index}
                  className="px-4 py-2 rounded-full border border-white/10 text-sm text-gray-300 hover:border-cyan-400 hover:text-cyan-300 transition duration-300"
                >
                  {item}
                </span>
              ))}
          ...
          >
            ...
            {/* Card 1 */}
            <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[30px] p-8 hover:-translate-y-3 transition duration-500">
            ...
            <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[30px] p-8 hover:-translate-y-3 transition duration-500">
              ...
              <FaServer className="text-4xl text-purple-400 mb-6" />
            ...
            <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[30px] p-8 hover:-translate-y-3 transition duration-500">
              ...
              <FaDatabase className="text-4xl text-cyan-400 mb-6" />
            ...
            <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[30px] p-8 hover:-translate-y-3 transition duration-500">
              ...
              <FaRocket className="text-4xl text-purple-400 mb-6" />
